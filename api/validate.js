 ...
 *
 * Endpoint "validate" per la Custom Decision Split in Journey Builder (SFMC).
 *
...
export default function handler(req, res) {
  ...
  console.log('[validate.js][STEP 1] Called', { method: req.method, url: req.url });

  // STEP 2 -- Risposta positiva a Journey Builder
  console.log('[validate.js][STEP 2] Responding success: true');
